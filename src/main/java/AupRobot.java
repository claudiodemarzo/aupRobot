...
public class AupRobot extends TelegramLongPollingBot {
    ...
    private final String DBURL = "jdbc:mysql://localhost:3306/nusgudpi_auprobot?allowPublicKeyRetrieval=true&useSSL=false", DBUNAME = "nusgudpi_auprobot", DBPASSWORD = "taMUD-}EE_s=";
